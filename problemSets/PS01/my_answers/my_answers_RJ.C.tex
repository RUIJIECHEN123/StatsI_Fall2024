...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=42, lastline=54]{my_answersRJ.C.R}
...
\lstinputlisting[language=R, firstline=115, lastline=122]{my_answersRJ.C.R}
    \begin{enumerate}
	\item[]
...
\lstinputlisting[language=R, firstline=123, lastline=135]{my_answersRJ.C.R}
   \begin{enumerate}
   	\item[]
  	\includegraphics[width=.85\textwidth]{plot.Y.Region_RJ.C.pdf}
   \end{enumerate}
\lstinputlisting[language=R, firstline=136, lastline=139]{my_answersRJ.C.R}
    \begin{verbatim}
    	                  Region        Y
    	                    4       4 88.30769
    \end{verbatim} 
...
\lstinputlisting[language=R, firstline=140, lastline=147]{my_answersRJ.C.R}
           \begin{enumerate}
           	\item[]
         	\includegraphics[width=.85\textwidth]{plot.Y.X1_RJ.C.pdf}
           \end{enumerate} 
\lstinputlisting[language=R, firstline=148, lastline=155]{my_answersRJ.C.R}
       %  \begin{table}[htbp]
       %  	\centering
       ...
       \begin{table}[!htbp] \centering 
    	...
    	per capita housing expenditure will also increase
       	\end{verbatim}
       \end{table}  
\lstinputlisting[language=R, firstline=156, lastline=167]{my_answersRJ.C.R}
           \begin{enumerate}
         	\item[]
...
\lstinputlisting[language=R, firstline=169, lastline=176]{my_answersRJ.C.R}
        \begin{enumerate}
    	 \item[]
	     \includegraphics[width=.85\textwidth]{plot.Y.X2_RJ.C.pdf}
        \end{enumerate}
\lstinputlisting[language=R, firstline=177, lastline=185]{my_answersRJ.C.R}
       \begin{table}[!htbp] \centering 
	    \caption{} 
	    \label{} 
   	    \begin{tabular}{@{\extracolsep{5pt}}lc} 
	     ...
	     \end{verbatim}
       \end{table} 
\lstinputlisting[language=R, firstline=186, lastline=197]{my_answersRJ.C.R}
           \begin{enumerate}
   	        \item[]
...
\lstinputlisting[language=R, firstline=199, lastline=206]{my_answersRJ.C.R}
          \begin{enumerate}
	       \item[]
...
\lstinputlisting[language=R, firstline=177, lastline=185]{my_answersRJ.C.R}
  \begin{table}[!htbp] \centering 
	...
	there is more expenditure on housing assistance
	 \end{verbatim}
  \end{table} 
\lstinputlisting[language=R, firstline=216, lastline=227]{my_answersRJ.C.R}
    \begin{enumerate}
	  \item[]
...
\lstinputlisting[language=R, firstline=229, lastline=236]{my_answersRJ.C.R}
    \begin{enumerate}
  	  \item[]
	  \includegraphics[width=.85\textwidth]{plot.X1.X2_RJ.C.pdf}
    \end{enumerate}
\lstinputlisting[language=R, firstline=237, lastline=245]{my_answersRJ.C.R}
  \begin{table}[!htbp] \centering 
	\caption{} 
	\label{} 
	\begin{tabular}{@{\extracolsep{5pt}}lc} 
	...
	\end{verbatim}
  \end{table} 
\lstinputlisting[language=R, firstline=246, lastline=257]{my_answersRJ.C.R}
  \begin{enumerate}
	\item[]
...
\lstinputlisting[language=R, firstline=259, lastline=266]{my_answersRJ.C.R}
  \begin{enumerate}
	\item[]
	\includegraphics[width=.85\textwidth]{plot.X1.X3_RJ.C.pdf}
  \end{enumerate}
\lstinputlisting[language=R, firstline=267, lastline=275]{my_answersRJ.C.R}
  \begin{table}[!htbp] \centering 
	\caption{} 
	\label{} 
	\begin{tabular}{@{\extracolsep{5pt}}lc} 
	...
	\end{verbatim}
  \end{table} 
\lstinputlisting[language=R, firstline=276, lastline=287]{my_answersRJ.C.R}
  \begin{enumerate}
	\item[]
...
\lstinputlisting[language=R, firstline=289, lastline=296]{my_answersRJ.C.R}
  \begin{enumerate}
	\item[]
	\includegraphics[width=.85\textwidth]{plot.X2.X3_RJ.C.pdf}
  \end{enumerate}
\lstinputlisting[language=R, firstline=297, lastline=305]{my_answersRJ.C.R}
  \begin{table}[!htbp] \centering 
	\caption{} 
	\label{} 
	\begin{tabular}{@{\extracolsep{5pt}}lc} 
	...
	\end{verbatim}
  \end{table}
\lstinputlisting[language=R, firstline=306, lastline=317]{my_answersRJ.C.R}
  \begin{enumerate}
	\item[]
